...
```gradle
dependencies {
    implementation 'com.github.apiverve:dkimvalidator-api:1.1.12'
}
```
...
```java
import com.apiverve.dkimvalidator.DKIMValidatorAPIClient;
import com.apiverve.dkimvalidator.APIResponse;
import com.apiverve.dkimvalidator.APIException;

// Initialize the client
DKIMValidatorAPIClient client = new DKIMValidatorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/dkimvalidator](https://docs.apiverve.com/ref/dkimvalidator)
...
- **Documentation:** [https://docs.apiverve.com/ref/dkimvalidator](https://docs.apiverve.com/ref/dkimvalidator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/dkimvalidator-api/issues)

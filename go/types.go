// Package dkimvalidator provides a Go client for the DKIM Validator API.
//
// For more information, visit: https://apiverve.com/marketplace/dkimvalidator?utm_source=go&utm_medium=readme
package dkimvalidator
...
// Request contains the parameters for the DKIM Validator API.
//
// Parameters:
//   - domain (required): string - The domain to validate the DKIM record for
type Request struct {
...
// ResponseData contains the data returned by the DKIM Validator API.
type ResponseData struct {
	DkimHost string `json:"dkim_host"`
	DkimRecord string `json:"dkim_record"`
	DkimRecordsCount int `json:"dkim_records_count"`
	HasDkimRecord bool `json:"has_dkim_record"`
	Host string `json:"host"`
	IssuesFound []IssuesFoundItem `json:"issues_found"`
...
// IssuesFoundItem represents an item in the IssuesFound array.
type IssuesFoundItem struct {

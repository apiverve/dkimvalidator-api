...
const (
	baseURL        = "https://api.apiverve.com/v1/dkimvalidator"
	defaultTimeout = 30 * time.Second
)

// Client is the DKIM Validator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new DKIM Validator API client.
...
// Execute makes a request to the DKIM Validator API with typed parameters.
//

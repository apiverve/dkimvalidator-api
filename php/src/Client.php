...
namespace APIVerve\Dkimvalidator;
...
/**
 * Client for the DKIM Validator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/dkimvalidator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/dkimvalidator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DkimvalidatorClient] {$message}\n";
        }
    }
}

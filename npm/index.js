...
class dkimvalidatorWrapper {
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/dkimvalidator`);
        }
    }
...
module.exports = dkimvalidatorWrapper;

# DKIM Validator API - Examples

This folder contains example code for using the DKIM Validator API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/dkimvalidator',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/dkimvalidator");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/dkimvalidator](https://docs.apiverve.com/ref/dkimvalidator)
